...
class ContactPageService
{
    ...
    public function __construct(
        private ContactSectionRepositoryInterface $sections,
    ) {}
    ...
    public function validateItems(ContactSectionPosition $position, ?array $items): void
    {
    ...
    {
        return "inquiry:contact:render:{$locale}";
    }
