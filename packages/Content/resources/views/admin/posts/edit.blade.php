...
@section('title', __('content::content.post.edit'))
@section('page-title', __('content::content.post.edit'))
...
<div class="max-w-5xl mx-auto">
    ...
    <form method="POST" action="{{ route(admin_route_name('posts.update'), $post->id) }}" class="space-y-6">
        @csrf
        @method('PUT')
