...
class AlliancePageService
{
    private const CACHE_TTL_SECONDS = 3600;

    public function __construct(
        private AllianceSectionRepositoryInterface $sections,
    ) {}
    ...
    public function validateItems(AllianceSectionPosition $position, ?array $items): void
    {
    ...
    {
        return "content:alliance:render:{$locale}";
    }
