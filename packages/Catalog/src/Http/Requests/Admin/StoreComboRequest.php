...
class StoreComboRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            // A Combo bundles Services and/or TourPackages. At least one of the two pivots
            // must be present; controller enforces business rule via custom message below.
            ...
            'translations.*.slug' => [
                ...
                'regex:/^[a-z0-9]+(?:-[a-z0-9]+)*$/',
                SlugUniquenessRule::make($this, 'combo_translations', 'combo_id', null),
            ],
