...
class StoreServiceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            // Comma-string forms are normalised to int[] in `prepareForValidation()` (trait) so the
            // per-element `exists` rule fires uniformly for both array and CSV submissions.
            ...
            // Avoid the "published-but-undated → hidden by Scout/repo" trap (same pattern as Page/Post).
            ...
            'translations.*.slug' => [
                ...
                'regex:/^[a-z0-9]+(?:-[a-z0-9]+)*$/',
                SlugUniquenessRule::make($this, 'service_translations', 'service_id', null),
            ],
