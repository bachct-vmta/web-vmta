...
@section('title', __('catalog::catalog.partner.edit'))
@section('page-title', __('catalog::catalog.partner.edit'))
...
<div class="max-w-5xl mx-auto">
    ...
    <form method="POST" action="{{ route(admin_route_name('partners.update'), $partner->id) }}" class="space-y-6">
        @csrf
        @method('PUT')
