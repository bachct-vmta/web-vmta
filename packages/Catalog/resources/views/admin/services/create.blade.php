...
@section('title', __('catalog::catalog.service.create'))
@section('page-title', __('catalog::catalog.service.create'))
...
<div class="max-w-5xl mx-auto">
    ...
    <form method="POST" action="{{ route(admin_route_name('services.store')) }}" class="space-y-6">
        @csrf
